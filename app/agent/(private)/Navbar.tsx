...
import { CreditCard, Home, LogOut, Menu, User } from "lucide-react";
    ...
    <div className="bg-gray-100">
            ...
            <Sheet open={isMobileMenuOpen} onOpenChange={toggleMobileMenu}>
              ...
              <SheetContent side="left">
                ...
                <div className="grid gap-4 py-4">
                  ...
                  <Button
                    onClick={() => handleSheetClick("/agent/cashin")}
                    variant="ghost"
                    className="justify-start"
                  >
                  ...
                  <Button
                    onClick={() =>
                      handleSheetClick("/agent/pendingtransactions")
                    }
                    variant="ghost"
                    className="justify-start"
                  >
      ...
      <nav className="hidden md:block fixed top-0 left-0 h-full w-64 font-semibold  bg-white dark:bg-gray-800 border-r p-4">
        ...
        <ul className="space-y-2 ">
          ...
          <Link href={"/agent/pendingtransactions"}>
            <li>
              <Button variant="ghost" className="w-full justify-start">
                <CreditCard className="mr-2 h-4 w-4" />
                Pending Transaction
